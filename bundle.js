...
class Freehand extends _entity__WEBPACK_IMPORTED_MODULE_3__["default"] {
     ...
     * @return  {void}                               [return description]
     */
    drawGuides(context, target, callback) {
...
class Layer {
    ...
    drawGuides(context, target) {
        for (let [key, entity] of this.entities) {
            entity.drawGuides(context, target, (vector) => {
                var _a, _b, _c;
                if (vector && ((_a = this.drawing) === null || _a === void 0 ? void 0 : _a.tool) && ((_b = this.drawing) === null || _b === void 0 ? void 0 : _b.tool.name) === "select") {
                    ((_c = this.drawing) === null || _c === void 0 ? void 0 : _c.tool).selected_vector = vector;
                }
            });
        }
    }
